 ...
 * @author casto
 */
@WebServlet(name = "EliminarPrendaCarrito", urlPatterns = {"/usuario/EliminarPrendaCarrito"})
public class EliminarPrendaCarrito extends HttpServlet {
