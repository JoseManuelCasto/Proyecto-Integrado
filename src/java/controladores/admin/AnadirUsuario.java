 ...
 * @author casto
 */
@WebServlet(name = "AnadirUsuario", urlPatterns = {"/admin/AnadirUsuario"})
public class AnadirUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String vista = "/admin/anadirUsuario.jsp";
        ...
        if (request.getParameter("anadir") != null) {
            ...
            modelo.ModeloUsuario.anadirUsuario(nombre, apellido, email, contrasena, rol);
